...
const Home = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>kenshi - Full Stack Geliştirici</title>
        <meta name="description"
          content="Web tabanlı uygulamalar geliştiriyor ve Discord botları ile ilgileniyorum. Portföyüm ve becerilerim için URL kenshi adresini ziyaret edin." />
      ...
      <div className='flex justify-center py-48 text-center'>
        <div>
          <h1 className='font-bold text-4xl sm:text-6xl'>Merhaba Ben <span className='text-sky-500 underline'>Kenshi</span></h1>
          <p className='text-gray-400 text-lg sm:text-xl mt-2 p-1'>Full-Stack geliştiriciyim. Kocaeli de yaşıyorum.<br />15 yaşındayım.</p>
        </div>
      </div>
