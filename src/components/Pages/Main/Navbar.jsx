        ...
        <div>
            ...
            <div className='flex justify-center sm:justify-between p-2 py-4 mt-4 mx-2 sm:mx-8 lg:mx-60 text-center bg-gray-700 rounded-full shadow-md'>
                <div className='mt-1 hidden sm:block'>
                    <span className='font-bold m-8 text-md'>kenshi</span>
                </div>
                ...
                <div className='flex gap-4'>
                    <a rel='nofollow' href='https://discord.com/users/709037184170197092' target='_blank' className="invisible sm:visible duration-300 cursor-pointer hover:bg-gray-900 w-8 h-8 rounded-full hidden sm:flex items-center justify-center">
                        <i className="bi bi-discord"></i>
                    </a>
                    <a rel='nofollow' href='https://github.com/kenshinomercy' target='_blank' className="invisible sm:visible duration-300 cursor-pointer hover:bg-gray-900 w-8 h-8 rounded-full hidden sm:flex items-center justify-center">
                        <i className="bi bi-github"></i>
                    </a>
                    <a rel='nofollow' href='https://www.youtube.com/@kenshi' target='_blank' className="invisible sm:visible duration-300 cursor-pointer hover:bg-gray-900 w-8 h-8 rounded-full hidden sm:flex items-center justify-center">
