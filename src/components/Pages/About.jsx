...
const About = () => {
    return (
        <div>
            <Helmet>
                <title>kenshi - Hakkımda</title>
                <meta name="description" content="Web tabanlı uygulamalar geliştiriyor ve Discord botları ile ilgileniyorum. Portföyüm ve becerilerim için URL kenshi adresini ziyaret edin." />
            ...
            <div className='mt-20'>
                ...
                <div className='py-0 px-0 sm:py-8 sm:px-20'>
                    <div className='flex gap-2 py-8 px-20'>
                        <img className='w-12 h-12 rounded-md mt-2 sm:mt-0' src="/" alt="kenshi" />
                        <span className='font-bold text-2xl text-gray-300 sm:mt-2'>kenshi kimdir?</span>
                    </div>
                    <div className='p-4 sm:p-1'>
                        <h2 className='text-lg text-gray-300 font-medium'>Merhaba, ben kenshi!</h2>
